const translations = {
  cs: {
    ...
    setPasswordDesc:
      "Volitelné: přihlaste se emailem a heslem, když nemáte telefon ani passkey po ruce.",
    // Record
    ...
    unlockWithPasskey: "Odemknout passkeyem",
  ...
  en: {
    ...
    setPasswordDesc:
      "Optional: sign in with email and password when you don't have your phone or passkey handy.",
